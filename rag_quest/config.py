...
class ConfigManager:
    ...
    DEFAULT_CONFIG = {
        ...
        # lore and replaces the raw `query_world()` injection in the system
        # prompt. Profile picks the §4.2 token budgets (fast/balanced/deep).
        # Set `assembler_enabled` to `false` to restore the legacy path.
        "memory": {
